/* The program stores student structs and prints average and highest grade.
*/
...
void get_average(std::vector<StudentStruct> &students_vect)
{
    double sum {0};
    for(const StudentStruct &student : students_vect)
    {
        sum += student.grade;
    }
